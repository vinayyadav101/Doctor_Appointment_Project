        ...
        <div class="content-container">
            ...
            <div class="payment-history">
                <div class="search-bar">
                    <input type="text" id="searchOrderId" placeholder="Search by payment ID">
                </div>
...
<div class="appointment-dashboard">
        ...
        <div class="content-container">
            ...
            <div class="payment-history">
                <div class="search-bar">
                    <input type="text" id="searchOrderId" placeholder="Search by appointment ID">
                </div>
                <div class="history-table-wrapper">
                    <table class="history-table" id="paymentHistoryTable">
                        <thead>
...
const users = `
    <div class="doctor-dashboard">
        <div class="search-bar">
            <input type="text" id="searchOrderId" placeholder="Search by user Email ID">
        </div>
        <div class = 'doctor-details-dashboard' style="display: none;">
            <div class="profile-container">
            <!-- Doctor's Information Section -->
